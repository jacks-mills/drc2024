...
#define ERR_PREFIX "control: "
#define OUT_PREFIX "control: "

#define NSEC_PER_SEC 1000000000


static void *control_thread(void *params);

pthread_t control_create_thread(int priority) {
    ...
    error = pthread_create(&thread, &attr, control_thread, NULL);
    if (error) {
